...
<%@ Page Title="Customer Report" Language="C#" MasterPageFile="~/UI/MasterPage.master" AutoEventWireup="true" CodeBehind="CustomerReport.aspx.cs" Inherits="RestaurantManagementSystem.UI.Reports.CustomerReport" %>

<asp:Content ID="Content1" ContentPlaceHolderID="TitleContent" runat="server">
    Customer Report - Restaurant Management System
</asp:Content>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="card border-0 shadow-sm mb-4">
        ...
        <div class="card-body">
            <div class="row g-3 align-items-end">
                ...
                <div class="col-md-3">
                    <label class="form-label fw-bold small">Min Loyalty Points</label>
                    <asp:TextBox ID="txtMinPoints" runat="server" CssClass="form-control" Text="0" />
                </div>
                <div class="col-md-3">
        ...
        <div class="col-md-3">
            <div class="card border-0 shadow-sm">
                <div class="card-body text-center">
                    <h6 class="text-muted small">Total Customers</h6>
                    <h3 class="fw-bold text-primary"><asp:Literal ID="ltrTotalCustomers" runat="server" Text="0" /></h3>
                </div>
            </div>
        </div>
        <div class="col-md-3">
            <div class="card border-0 shadow-sm">
                <div class="card-body text-center">
                    <h6 class="text-muted small">VIP Customers</h6>
                    <h3 class="fw-bold text-warning"><asp:Literal ID="ltrVIPCustomers" runat="server" Text="0" /></h3>
                </div>
            </div>
        </div>
        <div class="col-md-3">
            <div class="card border-0 shadow-sm">
                <div class="card-body text-center">
                    <h6 class="text-muted small">Total Loyalty Points</h6>
                    <h3 class="fw-bold text-success"><asp:Literal ID="ltrTotalPoints" runat="server" Text="0" /></h3>
                </div>
            </div>
        </div>
        <div class="col-md-3">
            <div class="card border-0 shadow-sm">
                <div class="card-body text-center">
                    <h6 class="text-muted small">Top Spender</h6>
                    <h3 class="fw-bold text-info">$<asp:Literal ID="ltrTopSpender" runat="server" Text="0.00" /></h3>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="card border-0 shadow-sm" id="divReport" runat="server" visible="false">
        <div class="card-header bg-white py-3 d-flex justify-content-between align-items-center">
            <h5 class="mb-0">
                <i class="fas fa-table me-2 text-primary"></i>Customer Details
            </h5>
            <span class="badge bg-primary rounded-pill">
                <asp:Literal ID="ltrRecordCount" runat="server" Text="0" /> Customers
            </span>
        </div>
                ...
                <asp:GridView ID="gvReport" runat="server" AutoGenerateColumns="True" 
                    ...
                    <EmptyDataTemplate>
                        <div class="text-center py-4">
                            ...
                            <p class="text-muted">No customer data found for the selected period</p>
                        </div>
                    </EmptyDataTemplate>
                </asp:GridView>
            </div>
            ...
            <div class="row">
                <div class="col-md-6">
                    <small class="text-muted">
                        ...
                        Customer report shows spending patterns and loyalty
                    </small>
                </div>
