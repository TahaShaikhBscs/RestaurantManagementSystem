...
<%@ Page Title="Sales Report" Language="C#" MasterPageFile="~/UI/MasterPage.master" AutoEventWireup="true" CodeBehind="SalesReport.aspx.cs" Inherits="RestaurantManagementSystem.UI.Reports.SalesReport" %>

<asp:Content ID="Content1" ContentPlaceHolderID="TitleContent" runat="server">
    Sales Report - Restaurant Management System
</asp:Content>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
            ...
            <div class="d-flex justify-content-between align-items-center">
                <div>
                    <h2 class="page-title mb-0">
                        <i class="fas fa-chart-bar text-primary me-2"></i>Sales Report
                    </h2>
                ...
                <div>
                    <asp:Button ID="btnExportPDF" runat="server" Text="PDF" CssClass="btn btn-danger me-2" OnClick="btnExportPDF_Click" />
                    <asp:Button ID="btnExportExcel" runat="server" Text="Excel" CssClass="btn btn-success" OnClick="btnExportExcel_Click" />
                </div>
            </div>
            <hr class="mt-2" />
        </div>
    ...
    <div class="card border-0 shadow-sm mb-4">
        ...
        <div class="card-body">
            <div class="row g-3 align-items-end">
                ...
                <div class="col-md-3">
                    <label class="form-label fw-bold small">Group By</label>
        ...
        <div class="col-md-3">
            <div class="card border-0 shadow-sm">
                <div class="card-body text-center">
                    ...
                    <h3 class="fw-bold text-primary"><asp:Literal ID="ltrTotalOrders" runat="server" Text="0" /></h3>
                </div>
            </div>
        </div>
        <div class="col-md-3">
            <div class="card border-0 shadow-sm">
                <div class="card-body text-center">
                    ...
                    <h3 class="fw-bold text-success">$<asp:Literal ID="ltrTotalSales" runat="server" Text="0.00" /></h3>
                </div>
            </div>
        </div>
        <div class="col-md-3">
            <div class="card border-0 shadow-sm">
                <div class="card-body text-center">
                    <h6 class="text-muted small">Average Order</h6>
                    <h3 class="fw-bold text-info">$<asp:Literal ID="ltrAvgOrder" runat="server" Text="0.00" /></h3>
                </div>
            </div>
        </div>
        <div class="col-md-3">
            <div class="card border-0 shadow-sm">
                <div class="card-body text-center">
                    <h6 class="text-muted small">Total Tax</h6>
                    <h3 class="fw-bold text-warning">$<asp:Literal ID="ltrTotalTax" runat="server" Text="0.00" /></h3>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="card border-0 shadow-sm" id="divReport" runat="server" visible="false">
        <div class="card-header bg-white py-3 d-flex justify-content-between align-items-center">
            <h5 class="mb-0">
                <i class="fas fa-table me-2 text-primary"></i>Sales Report Details
            </h5>
            ...
            <div class="row">
                <div class="col-md-6">
                    <small class="text-muted">
                        ...
                        Sales report shows revenue by selected period
                    </small>
                </div>
