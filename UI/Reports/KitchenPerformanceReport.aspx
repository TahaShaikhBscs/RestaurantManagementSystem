...
<%@ Page Title="Kitchen Performance Report" Language="C#" MasterPageFile="~/UI/MasterPage.master" AutoEventWireup="true" CodeBehind="KitchenPerformanceReport.aspx.cs" Inherits="RestaurantManagementSystem.UI.Reports.KitchenPerformanceReport" %>

<asp:Content ID="Content1" ContentPlaceHolderID="TitleContent" runat="server">
    Kitchen Performance Report - Restaurant Management System
</asp:Content>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
            ...
            <div class="d-flex justify-content-between align-items-center">
                <div>
                    <h2 class="page-title mb-0">
                        <i class="fas fa-utensils text-primary me-2"></i>Kitchen Performance Report
                    </h2>
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb small mb-0">
                            <li class="breadcrumb-item"><a href="~/Dashboard.aspx">Dashboard</a></li>
                            <li class="breadcrumb-item"><a href="ReportList.aspx">Reports</a></li>
                            <li class="breadcrumb-item active" aria-current="page">Kitchen Performance</li>
                        </ol>
                    </nav>
                </div>
                <div>
    ...
    <div class="row mb-4" id="divSummary" runat="server" visible="false">
        ...
        <div class="col-md-3">
            <div class="card border-0 shadow-sm">
                <div class="card-body text-center">
                    <h6 class="text-muted small">Avg Prep Time</h6>
                    <h3 class="fw-bold text-success"><asp:Literal ID="ltrAvgPrepTime" runat="server" Text="0" /> min</h3>
                </div>
            </div>
        </div>
        <div class="col-md-3">
            <div class="card border-0 shadow-sm">
                <div class="card-body text-center">
                    <h6 class="text-muted small">On Time</h6>
                    <h3 class="fw-bold text-info"><asp:Literal ID="ltrOnTime" runat="server" Text="0" />%</h3>
                </div>
            </div>
        </div>
        <div class="col-md-3">
            <div class="card border-0 shadow-sm">
                <div class="card-body text-center">
                    <h6 class="text-muted small">Cancelled</h6>
                    <h3 class="fw-bold text-danger"><asp:Literal ID="ltrCancelled" runat="server" Text="0" /></h3>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="card border-0 shadow-sm" id="divReport" runat="server" visible="false">
        <div class="card-header bg-white py-3 d-flex justify-content-between align-items-center">
            <h5 class="mb-0">
                <i class="fas fa-table me-2 text-primary"></i>Kitchen Performance Details
            </h5>
                ...
                <asp:GridView ID="gvReport" runat="server" AutoGenerateColumns="True" 
                    ...
                    <EmptyDataTemplate>
                        <div class="text-center py-4">
                            ...
                            <p class="text-muted">No kitchen performance data found for the selected period</p>
                        </div>
                    </EmptyDataTemplate>
                </asp:GridView>
            </div>
            ...
            <div class="row">
                <div class="col-md-6">
                    <small class="text-muted">
                        ...
                        Kitchen performance report shows efficiency metrics
                    </small>
                </div>
