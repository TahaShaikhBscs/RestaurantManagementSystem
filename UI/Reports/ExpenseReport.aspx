...
<%@ Page Title="Expense Report" Language="C#" MasterPageFile="~/UI/MasterPage.master" AutoEventWireup="true" CodeBehind="ExpenseReport.aspx.cs" Inherits="RestaurantManagementSystem.UI.Reports.ExpenseReport" %>

<asp:Content ID="Content1" ContentPlaceHolderID="TitleContent" runat="server">
    Expense Report - Restaurant Management System
</asp:Content>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
            ...
            <div class="d-flex justify-content-between align-items-center">
                <div>
                    <h2 class="page-title mb-0">
                        <i class="fas fa-money-bill-wave text-primary me-2"></i>Expense Report
                    </h2>
        ...
        <div class="col-md-3">
            <div class="card border-0 shadow-sm">
                <div class="card-body text-center">
                    ...
                    <h3 class="fw-bold text-danger">$<asp:Literal ID="ltrTotalAmount" runat="server" Text="0.00" /></h3>
                </div>
            </div>
        </div>
        <div class="col-md-3">
            <div class="card border-0 shadow-sm">
                <div class="card-body text-center">
                    <h6 class="text-muted small">Average Expense</h6>
        ...
        <div class="col-md-3">
            <div class="card border-0 shadow-sm">
                <div class="card-body text-center">
                    ...
                    <h3 class="fw-bold text-primary"><asp:Literal ID="ltrTotalTransactions" runat="server" Text="0" /></h3>
                </div>
            </div>
        </div>
        <div class="col-md-3">
            <div class="card border-0 shadow-sm">
                <div class="card-body text-center">
                    <h6 class="text-muted small">Categories</h6>
                    <h3 class="fw-bold text-info"><asp:Literal ID="ltrCategoryCount" runat="server" Text="0" /></h3>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="card border-0 shadow-sm" id="divReport" runat="server" visible="false">
        <div class="card-header bg-white py-3 d-flex justify-content-between align-items-center">
            <h5 class="mb-0">
                <i class="fas fa-table me-2 text-primary"></i>Expense Details
            </h5>
                ...
                <asp:GridView ID="gvReport" runat="server" AutoGenerateColumns="True" 
                    ...
                    <EmptyDataTemplate>
                        <div class="text-center py-4">
                            ...
                            <p class="text-muted">No expense data found for the selected period</p>
                        </div>
                    </EmptyDataTemplate>
                </asp:GridView>
            </div>
            ...
            <div class="row">
                <div class="col-md-6">
                    <small class="text-muted">
                        ...
                        Expense report shows all expenses by category
                    </small>
                </div>
